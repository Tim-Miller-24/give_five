<template>
  <div v-if="isItemExistsInStoke" class="modal-product-recommended-item" @click="openProduct()">
    <div class="modal-product-recommended-item__image">
      <img v-lazy-load :data-src="itemImage" alt="" :src="itemImage" loading="lazy">
    ...
    <div class="modal-product-recommended-item__content">
      ...
      <CommonPriceBlock :product="props.item" v-if="!isAppStyle" :regular-price="itemRegularPrice" :price="itemPrice" is-reverse />
