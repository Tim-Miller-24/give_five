<template>
  <div class="modal-cart-item" @click="openProduct" v-if="!isItSupplement">
    <button
      class="modal-cart-item__remove"
      @click.stop="removeFromCart()"
      v-if="props.item.id !== cart.promocode?.productId"
    >
      <UIIcon name="trash" />
    </button>
    <div class="modal-cart-item__main">
      ...
      <div class="modal-cart-item__content">
        ...
        <div class="modal-cart-item__footer">
          ...
          <UICounter
              v-if="!isDiscountProduct && props.item.id !== cart.promocode?.productId"
              :count="counterLabel"
              :id="item.id"
              @increment="increment()"
              @decrement="decrement()"
